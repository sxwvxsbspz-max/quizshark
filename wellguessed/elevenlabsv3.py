...
"""
ElevenLabs v3 Quizmaster TTS (Wellguessed)
...
- NEU: Protokoll:
  ...
  - schreibt in wellguessed/11labsprotokoll.txt

Datei:
  wellguessed/elevenlabsv3.py
"""
...
BASE_DIR = os.path.dirname(os.path.abspath(__file__))           # .../wellguessed
...
def main():
    ...
    append_log("")
    append_log("============================================================")
    append_log(f"[{now_stamp()}] START elevenlabsv3.py (Wellguessed)")
