// --- FILE: ./soundmemory/static/controller.js ---
...
const memoOverlayEl = document.querySelector(".memo-overlay");
...
socket.on("show_memo", (data) => {
  ...
  if (memoOverlayEl) memoOverlayEl.classList.add("is-playing");
});
...
socket.on("hide_memo", () => {
  if (memoOverlayEl) memoOverlayEl.classList.remove("is-playing");
  if (memoScreen) memoScreen.style.display = "none";
});
