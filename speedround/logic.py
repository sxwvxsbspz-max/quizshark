...
class PunktesammlerQuestionSource:
    ...
    def next_question(self) -> dict:
        ...
        pool = questions[:20] if len(questions) > 20 else questions
...
class SpeedroundLogic:
    ...
    def __init__(self, socketio, players, on_game_finished=None):
        ...
        # - Fragenpfad
        # ---------------------------------------------
        questions_path = os.path.join(os.path.dirname(__file__), "..", "punktesammler", "questions.json")
        ...
        scoring = TimeLinearScoring(max_points=150, min_points=50)
