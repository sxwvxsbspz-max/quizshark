...
"""
ElevenLabs v3 Quizmaster TTS (Customquiz)
...
- NEU: Protokoll:
  ...
  - schreibt in customquiz/11labsprotokoll.txt

Datei:
  customquiz/elevenlabsv3.py
"""
...
BASE_DIR = os.path.dirname(os.path.abspath(__file__))           # .../customquiz
...
def main():
    ...
    append_log("")
    append_log("============================================================")
    append_log(f"[{now_stamp()}] START elevenlabsv3.py (Customquiz)")
