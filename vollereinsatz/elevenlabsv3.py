...
"""
ElevenLabs v3 Quizmaster TTS (vollereinsatz)
- liest questions.json
- erzeugt MP3s in ./media/audio
- Naming: question-<id>.mp3
- v3 Handling:
...
- NEU: Protokoll:
  ...
  - schreibt in vollereinsatz/11labsprotokoll.txt

Datei:
  vollereinsatz/elevenlabsv3.py
"""
...
BASE_DIR = os.path.dirname(os.path.abspath(__file__))           # .../vollereinsatz
...
def main():
    ...
    append_log("")
    append_log("============================================================")
    append_log(f"[{now_stamp()}] START elevenlabsv3.py (vollereinsatz)")
    ...
    for idx, q in enumerate(questions, start=1):
        ...
        audio_name = f"question-{qid}.mp3"
        out_path = os.path.join(AUDIO_DIR, audio_name)

        # JSON immer auf dieses Schema setzen
